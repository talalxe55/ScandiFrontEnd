  ...
  const productElementGrid = allProducts.map((product) => {
    return (
      <ProductGrid
        ...
        book_weight={product.book_weight}
        dvd_size={product.dvd_size}
        furniture_height={product.furniture_height}
        furniture_width={product.furniture_width}
        furniture_length={product.furniture_length}
